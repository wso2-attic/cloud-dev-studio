...
public interface RegistryExtConstants {
	...
	WizardContext.Key<String> WKEY_MAVEN_ARTIFACT_ID =
			new WizardContext.Key<String>(RegistryExtConstants.MAVEN_ARTIFACT_ID);
	WizardContext.Key<String> WKEY_MAVEN_GROUP_ID =
			new WizardContext.Key<String>(RegistryExtConstants.MAVEN_GROUP_ID);
	WizardContext.Key<String> WKEY_MAVEN_VERSION =
			new WizardContext.Key<String>(RegistryExtConstants.MAVEN_VERSION);
