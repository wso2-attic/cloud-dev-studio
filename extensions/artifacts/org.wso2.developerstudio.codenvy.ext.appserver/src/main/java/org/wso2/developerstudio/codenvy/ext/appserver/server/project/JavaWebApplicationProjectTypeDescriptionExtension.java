...
@Singleton
public class JavaWebApplicationProjectTypeDescriptionExtension
		implements ProjectTypeDescriptionExtension {

	@Inject
	public JavaWebApplicationProjectTypeDescriptionExtension(
