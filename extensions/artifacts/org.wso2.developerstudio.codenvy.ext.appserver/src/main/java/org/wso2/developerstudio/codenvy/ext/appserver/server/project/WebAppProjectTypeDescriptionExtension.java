...
@Singleton
public class WebAppProjectTypeDescriptionExtension implements ProjectTypeDescriptionExtension {

	@Inject
	public WebAppProjectTypeDescriptionExtension(ProjectTypeDescriptionRegistry registry) {
